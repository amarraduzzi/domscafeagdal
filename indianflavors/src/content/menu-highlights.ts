    ...
    items: [
      {
        ...
        priceMAD: 32,
        vegetarian: true,
        image: 'https://i.ibb.co/4qYvL8Y/Chat-GPT-Image-21-jul-2026-08-50-56.webp',
      ...
      },
      {
        ...
        description: {
          ...
          en: 'Mozzarella, chicken, peppers, mushrooms, tomato sauce.',
          ar: 'موزاريلا، دجاج، فلفل، فطر، صلصة الطماطم.',
        },
        priceMAD: 42,
        image: 'https://i.ibb.co/9kJnfr2Z/Chat-GPT-Image-21-jul-2026-08-57-53.webp',
        imageAlt: { fr: 'Pizza Pollo', en: 'Pollo pizza', ar: 'بيتزا بولو' },
      },
    ],
  },
  {
